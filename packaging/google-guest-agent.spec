...
%build
for bin in google_authorized_keys google_guest_agent google_metadata_script_runner gce_workload_cert_refresh; do
  pushd "$bin"
...
install -p -m 0755 google_authorized_keys/google_authorized_keys %{buildroot}%{_bindir}/google_authorized_keys_guest
