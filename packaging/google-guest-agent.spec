...
pushd %{name}-extra-%{version}/
  ...
  make cmd/mwlid_extension/mwlid_extension
...
install -d %{buildroot}%{_exec_prefix}/lib/google/guest_agent/ManagedWorkloadIdentityExtension
install -p -m 0644 %{name}-extra-%{version}/build/configs/usr/lib/google/guest_agent/ManagedWorkloadIdentityExtension/manifest.binpb %{buildroot}%{_exec_prefix}/lib/google/guest_agent/ManagedWorkloadIdentityExtension/manifest.binpb
install -p -m 0755 %{name}-extra-%{version}/cmd/mwlid_extension/mwlid_extension %{buildroot}%{_exec_prefix}/lib/google/guest_agent/ManagedWorkloadIdentityExtension/mwlid_extension
...
%{_exec_prefix}/lib/google/guest_agent/ManagedWorkloadIdentityExtension/mwlid_extension
%{_exec_prefix}/lib/google/guest_agent/ManagedWorkloadIdentityExtension/manifest.binpb
